...
@click.option(
    "--fname", default=None, help="Name of the file, defaults to ~/Desktop/NAME"
)
@click.option(
    "--icon",
    default="/home/pi/Pictures/basic.jpg",
    help="Path to icon file, defaults to /home/pi/Pictures/basic.jpg",
)
